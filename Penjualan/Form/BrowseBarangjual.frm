...
Begin VB.Form BrowseBarangBeli 
   ...
   MaxButton       =   0   'False
   MinButton       =   0   'False
   Picture         =   "BrowseBarangjual.frx":0000
   ScaleHeight     =   3780
   ScaleWidth      =   6240
...
Sub Pilih()
FormTransaksiPembelian.TxtIdBarang.Text = rs(0)
FormTransaksiPembelian.TxtNamaBarang.Text = rs(2)
FormTransaksiPembelian.TxtHargaBarang.Text = rs(3)
Unload Me
FormTransaksiPembelian.TxtJumlah.SetFocus
End Sub
