VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} LaporanBeliBulan 
   ...
   _ExtentX        =   19447
   _ExtentY        =   14129
   SectionData     =   "LaporanBeliBulan.dsx":0000
End
Attribute VB_Name = "LaporanBeliBulan"
...
With DataControl1.Recordset
        If Not .EOF Then
            Field1.Text = .Fields("tanggalBeli").Value
