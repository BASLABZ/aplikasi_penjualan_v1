VERSION 5.00
Begin {9EB8768B-CDFA-44DF-8F3E-857A8405E1DB} LaporanjualPer 
   ...
   _ExtentX        =   19447
   _ExtentY        =   12488
   SectionData     =   "Laporanjualbulanan.dsx":0000
End
Attribute VB_Name = "LaporanjualPer"
...
With DataControl1.Recordset
        If Not .EOF Then
            Field1.Text = .Fields("tglJual").Value
